...
class PublicUserApiTests(TestCase):
    ...
    def test_password_restriction(self):
        """
        Test that the password must be atleast 8 characters long.
        """
        payload = {
            'email': 'test@example.com',
            'password': 'pass',
    ...
    def test_create_token_missing_field(self):
        """
        Test that email and password is required to create token.
        """
        payload = {
            'email': 'test@example.com',
            'password': '',
...
class PrivateUserApiTests(TestCase):
    ...
    def test_retrieve_profile_success(self):
        """
        Test retrieve profile for authenticated logged in user.
        """
        res = self.client.get(PROFILE_URL)
        self.assertEqual(res.status_code, status.HTTP_200_OK)
    ...
    def test_post_profile_not_allowed(self):
        """
        Test that POST method is not allowed on the profile url.
        """
