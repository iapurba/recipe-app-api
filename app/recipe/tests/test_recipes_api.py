...
def image_update_url(recipe_id):
...
class PublicRecipeApiTests(TestCase):
    ...
    def test_auth_required(self):
        """
        Test that authentication is required to get access to recipe endpoint
        """
...
class RecipeImageUploadTest(TestCase):
    ...
    def test_upload_image_to_recipe(self):
        ...
        url = image_update_url(self.recipe.id)
    ...
    def test_filter_recipe_by_ingredients(self):
        ...
        ingredient1 = sample_ingredient(user=self.user, name='Chees')
